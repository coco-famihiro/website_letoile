...
export function ConceptSection() {
  return (
    <section className="gradient-sky-subtle py-20 md:py-28 px-4">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="space-y-5">
            <p className="text-lavender leading-relaxed text-sm md:text-base">
          ...
          <div className="relative">
            <div className="aspect-[4/3] rounded-2xl bg-gradient-to-br from-navy to-indigo border border-lavender/10 flex items-center justify-center overflow-hidden">
              <StarDecoration />
            </div>
          </div>
        </div>
